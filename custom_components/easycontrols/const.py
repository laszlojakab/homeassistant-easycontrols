...
VARIABLE_HUMIDITY_FTF1 = IntModbusVariable('v00111', 4)
VARIABLE_HUMIDITY_FTF2 = IntModbusVariable('v00112', 4)
VARIABLE_TEMPERATURE_FTF1 = FloatModbusVariable('v00119', 7)
VARIABLE_TEMPERATURE_FTF2 = FloatModbusVariable('v00120', 7)
